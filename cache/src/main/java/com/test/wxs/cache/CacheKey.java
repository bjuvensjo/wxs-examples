...
public interface CacheKey {
    ...
    /**
     * Returns a Serializable representation of this CacheKey that is used as key by Cache implementations.
     * The Serializable must implement equals() and hashCode().
     * 
